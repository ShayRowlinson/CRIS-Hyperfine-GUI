...
Named V3 for consistency with other files, functionally identical to V1 with minor comments added.
...
class CentroidPlot(ttk.Frame):
    """
    Plotting centroid frequency vs scan number for chosen isotope.
    """
    ...
    def _load_and_plot(self):
        ...
        try:
            ...
            self.ax.axhline(mean + std, color='green', linestyle=':', label="±1σ")
            self.ax.axhline(mean - std, color='green', linestyle=':')
