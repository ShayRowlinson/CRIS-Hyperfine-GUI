...
Requires binning_v2.py, fitting_v2.py, centroid_plot_v1.py, extract_moments_v1.py and Dopplershift_analysis.py, interpolate_ISCOOL.py
V2 with scan combining and isomeric fitting
...
from binning_v2 import Binning
from fitting_v2 import Fitting
