...
Requires binning_v3.py, fitting_v3.py, centroid_plot_v3.py, extract_moments_v3.py and Dopplershift_analysis.py, interpolate_ISCOOL.py
V3 with scan combining, isomeric fitting, ML estimation, moments plots and various QoL updates.
...
from binning_v3 import Binning
from fitting_v3 import Fitting
from centroid_plot_v3 import CentroidPlot
from extract_moments_v3 import Moments

class MainGUI(tk.Tk):
    """
    Main GUI launcher for CRIS Analysis with tab interface.
    Tabs:
